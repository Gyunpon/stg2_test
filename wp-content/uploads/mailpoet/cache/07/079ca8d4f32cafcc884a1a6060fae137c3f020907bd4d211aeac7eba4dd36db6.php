...
";
    ...
    {
        return new Source("", "emails/newSubscriberNotification.txt", "/home/kusanagi/stg/DocumentRoot/wp-content/plugins/mailpoet/views/emails/newSubscriberNotification.txt");
    }
}
