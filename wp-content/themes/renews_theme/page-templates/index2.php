...
<!-- 追加分ここまで -->
	...
	<div class="inner_base">
		...
		<div class="title_thin">
			<h1 class="main_title">New articles</h1>
			<span class="title_thin_img white">
				<a href="<?php echo home_url(); ?>/article/"><h2>すべての新着→</h2></a>
			</span>
		</div>
...
<section class="sec sec_column">
	<div class="inner_base">
		<div class="title_thin">
			<h1 class="main_title">Series</h1>
			<span class="title_thin_img">
...
<section class="sec sec_keyword">
	<div class="inner_base">
		<div class="title_thin">
			<h1 class="main_title">Keyword</h1>
			<span class="title_thin_img white">
				<h2>注目のキーワード</h2>
			</span>
		</div>
...
<section class="sec sec_renewer">
	<div class="inner_base">
		<div class="title_thin">
			<h1 class="main_title">Renewer</h1>
			<span class="title_thin_img">
...
<?php
	...
	<div class="news">
		<div class="title_thin">
			<h1 class="main_title">Info</h1>
			<span class="title_thin_img beige">
				<a href="<?php echo home_url(); ?>/renewers/"><h2>お知らせ  →</h2></a>
			</span>
		</div>
