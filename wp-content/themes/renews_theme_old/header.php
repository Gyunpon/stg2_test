...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
	...
	<?php if(is_page_template(array('page-templates/member.php','page-templates/member_under.php')) || is_page(array('bookmark')) ||$_GET['profiletab'] == 'following'): ?>
	...
	<?php if(is_page_template('page-templates/member.php')): ?>
						...
						<section id="menu">
							...
							<div class="inner_menu_sp">
								...
								<div class="flex list_mypage">
									<a href="<?php echo home_url(); ?>/member/">マイページ</a>
									<div class="user_avatar">
										<a href="<?php echo home_url(); ?>/member/">
