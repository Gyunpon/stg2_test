...
<!--
					<div class="sign_in">
						<a href="<?php echo network_home_url(); ?>wp-login.php" target="_blank">CMS</a>
					</div>
-->
					<?php endif; ?>
					<div class="sign_up <?php if(is_page(array('login','register'))){echo 'headLoginBtn';} ?>">
						<div class="user_avatar">
							<a href="<?php echo network_home_url(); ?>notifications/">
								...
								<div class="userIcon"><?php echo get_avatar($user->ID, 64); ?></div>
...
<!--						<a class="popup-modal" href="#modalLoginWrap">ログイン</a>-->
					...
					<div class="sign_up">
						<a href="<?php echo network_home_url(); ?>register/">新規登録</a>
					</div>
					<?php endif; ?>
					</div><!-- sign_wrap -->
				</div>
								...
								<div class="inner_menu_sp">
									...
									<div class="inner_menu_sp_scroll">
										...
										<div class="inner_menu_sp_block">
											...
											<div class="item_menu_sp">
												<a href="<?php echo network_home_url(); ?>info/contact/">情報提供／お問い合わせ</a>
											</div>
											<div class="item_menu_sp">
