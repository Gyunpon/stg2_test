...
-->
		...
		<div class="wrap_sitemap flex for_pc">
			<div class="sitemap flex">
				...
				<li class="item_sitemap">
					<a href="<?php echo network_home_url(); ?>about/?move=company" class="target_sitemap">
						会社概要
					</a>
				</li>
				<?php if(is_user_logged_in()): ?>
				<li class="item_sitemap">
					<a href="<?php echo network_home_url(); ?>logout/" class="target_sitemap">
						ログアウト
					</a>
				</li>
				<?php endif; ?>
		...
		<div class="wrap_sitemap flex for_sp">
			...
			<ul class="sitemap flex">
				...
				<li class="item_sitemap for_sp">
					<a href="<?php echo network_home_url(); ?>about/" class="target_sitemap">
						リニューズとは
					</a>
				</li>
			</ul>
...
<div id="modalLoginWrap" class="mfp-hide">
	<div id="modalLogin">
		<div id="modalLoginHead" class="mypageHead shadow">
			...
			<div class="text_read">
				アカウントをお持ちでない方は<a href="<?php echo network_home_url(); ?>register/">メンバー登録</a>
			</div>
		</div><!-- modalLoginHead -->
